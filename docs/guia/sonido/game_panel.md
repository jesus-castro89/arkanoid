---
title: Actualizando GamePanel
description: Actualización de la lógica principal del juego
editLink: false
---

# GamePanel <Badge type="warning" text="Modificada" vertical="middle" />

Dentro de nuestra agregaremos el AudioPlayer, pero además modificaremos algunas funciones para que actúen sobre el
reproductor, de igual manera si la pelota llega a la parte inferior haremos que el contador de vidas disminuya, por lo
que ahora nuestra clase se verá así:
...
```java{13,40,59,71-74,82,90,262-272,305,306}
package ui;
...
En el caso de la línea 176, estamos usando una fuente, pero puedes descargar la fuente de tu preferencia en formato
ttf y usarla.
